...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        questionLabel.text = quizzy.question(currentQuestionIndex) //The questions array has been moved to the quiz class, use the quizzy reference to access it
    }
    ...
    @IBAction func showNextQuestion(_ sender: UIButton) {
        ...
        let question: String = quizzy.question(currentQuestionIndex)
        questionLabel.text = question
        answerLabel.text = "???"
    }
    
    @IBAction func showAnswer(_ sender: UIButton) {
        let answer: String = quizzy.answer(currentQuestionIndex) //The answers array has been moved to the quiz class, use the quizzy reference to access it
